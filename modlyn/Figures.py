...
class NatureFigures:
    ...
    def figure_1_model_overview(self):
        ...
        axes[0, 1].bar(range(len(class_var)), class_var, color="#A23B72")
    ...
    def figure_2_scanpy_dotplot(self, top_k=25):
        ...
        obs_df = pd.DataFrame(
            {"perturbation": self.class_names, "group": self.class_names}
        )
        ...
        sc.pl.dotplot(
            ...
            size_title="|Weight|",
            figsize=(
                min(20, len(top_genes) * 0.6),
                min(15, len(self.class_names) * 0.4),
            ),
            return_fig=True,
        )
    ...
    def figure_4_pathway_analysis(self, top_k=20):
        ...
        axes[0].set_xticklabels(
            [self.gene_names[top_genes_idx[i]] for i in gene_order],
            rotation=45,
            ha="right",
        )
        ...
        axes[1].set_xticklabels(
            [self.gene_names[i] for i in top_genes_idx], rotation=45, ha="right"
        )
